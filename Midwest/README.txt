This is an entirely synthetic power system network model that covers the geographic footprint of 3 midwest states: Michigan, Ohio, and Indiana. 
The case is designed with a 765, 345, 138 and 69 kV transmission network to serve a load that roughly mimics the actual population of its 
